...
<div className="mt-10 md:mb-4 mb-0 flex w-full justify-center">
  <div className="md:inline-flex items-center h-full gap-4">
    <figure>
      <img
    ...
    <figure>
      ...
      <figcaption className="mt-2 text-xs opacity-60 md:w-[150px]">
